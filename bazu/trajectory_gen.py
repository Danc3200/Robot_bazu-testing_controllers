...
class Trajectory_publisher(Node):
    ...
    def __init__(self):
        ...
        self.goal_positions_2 = [0.1,0.1,0.1,0.1,0.9,0.8]
    ...
    def timer_callback(self):
        ...
        point_2.positions = self.goal_positions_2
        point_2.time_from_start = Duration(sec=4)
       
        ## adding newly created point into trajectory message
        bazu_trajectory_msg.points.append(point_2)
        self.trajectory_publihser.publish(bazu_trajectory_msg)
